...
s6 = [PCA_data(r3<=R,1), PCA_data(r3<=R,2)];
...
s7 = [PCA_data(r4<=R,1), PCA_data(r4<=R,2)];


r_values = [r1, r2 ,r3, r4];
%plot(datatest(:,1),datatest(:,2),'^')
dlmwrite('csa_450_rvals.txt', r_values, 'delimiter','\t') ; %write out to txt file
...
dlmwrite('csa_450_state_tba.txt', State_TBA, 'delimiter','\t') ; %write out to txt file
...
dlmwrite('CsA_450K_S1_Frames_12.txt', f1, 'delimiter','\t') ; 
dlmwrite('CsA_450K_S2_Frames_12.txt', f2, 'delimiter','\t') ; 
dlmwrite('CsA_450K_S3_Frames_12.txt', f3, 'delimiter','\t') ; 
dlmwrite('CsA_450K_S4_Frames_13.txt', f4, 'delimiter','\t') ; %write out states to txt file
...
dlmwrite('csa_450_TBA_check.txt', comp, 'delimiter','\t') ; %write out states to txt file
dlmwrite('csa_450_TBA_states.txt', State', 'delimiter', '\t');
...
VLM_state=[val1', len1']; 
dlmwrite('csa_450_Len_Vals_check.txt', VLM_state, 'delimiter', '\t'); %write out to txt file
...
dlmwrite('csa_450_prob_matrix.txt', PM, 'delimiter', '\t'); %write out to txt file
...
dlmwrite('450_csa_rate_matrix13.txt', K, 'delimiter', '\t'); %write out to txt file
dlmwrite('450_csa_count_matrix13.txt', CM_test, 'delimiter', '\t'); %write out to txt file
dlmwrite('450_csa_count_matrix13_TBA.txt', CM, 'delimiter', '\t'); %write out to txt file
...
st = [t , states];
dlmwrite('CsA_450K_TBA_traj.txt', st, 'delimiter','\t') ; 
